export const formatResponseBodyBySongInfo = songInfo => {
    return {...songInfo,
...
export const convertSecondsToTime = seconds => new Date(seconds * 1000).toISOString().substr(11, 8);

export const getFormatContainersByFormats = formats => {
