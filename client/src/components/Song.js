	...
	return (
		<tr className="song row-center">
			...
			<td className="song-artist-td songs-table-td">
				<a
					className="song-link font"
					href={song.channel_url}
					target="_blank"
			...
			<td className="songs-table-td download-song-td">
				<a
					className="fa fa-download download-song-button"
					download={songFilename}
					href={songUrl}
					title={config.downloadSongButtonTitle}
				/>
			</td>
			<td
				className="delete-song-button songs-table-td"
				title={config.deleteSongButtonTitle}
